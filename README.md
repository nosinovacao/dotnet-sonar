...
* dotnetcore-sdk 7.0.406
* dotnetcore-runtime 7.0.16 (required by Sonar-Scanner)
...
* `24.01.5`, `latest8`, `latest`, `24.01-dotnet8` [(24.01.5/Dockerfile)](https://github.com/nosinovacao/dotnet-sonar/blob/24.01.5/Dockerfile)
  * DotNet 8.0.100
