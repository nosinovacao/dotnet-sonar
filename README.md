...
* dotnetcore-sdk 9.0.303
* dotnetcore-runtime 9.0.7 (required by Sonar-Scanner)
...
* `25.07.6`, `latest9`, `latest`, `25.07-dotnet9` [(25.07.6/Dockerfile)](https://github.com/nosinovacao/dotnet-sonar/blob/25.07.6/Dockerfile)
  * DotNet 9.0.303
