...
* dotnetcore-sdk 9.0.300
* dotnetcore-runtime 9.0.5 (required by Sonar-Scanner)
...
* `25.06.6`, `latest9`, `latest`, `25.06-dotnet9` [(25.06.6/Dockerfile)](https://github.com/nosinovacao/dotnet-sonar/blob/25.06.6/Dockerfile)
  * DotNet 9.0.300
