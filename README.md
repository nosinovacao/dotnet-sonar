...
* dotnetcore-sdk 6.0.423
* dotnetcore-runtime 6.0.31 (required by Sonar-Scanner)
...
* `24.05.5`, `latest8`, `latest`, `24.05-dotnet8` [(24.05.5/Dockerfile)](https://github.com/nosinovacao/dotnet-sonar/blob/24.05.5/Dockerfile)
  * DotNet 8.0.300
