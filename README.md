...
* dotnetcore-sdk 8.0.412
* dotnetcore-runtime 8.0.18 (required by Sonar-Scanner)
...
* `25.07.5`, `latest8`, `25.07-dotnet8` [(25.07.5/Dockerfile)](https://github.com/nosinovacao/dotnet-sonar/blob/25.07.5/Dockerfile)
  * DotNet 8.0.412
