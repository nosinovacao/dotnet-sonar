...
* dotnetcore-sdk 5.0.403
* dotnetcore-runtime 5.0.12 (required by Sonar-Scanner)
...
* `21.07.1`, `latest` [(21.11.1/Dockerfile)](https://github.com/nosinovacao/dotnet-sonar/blob/21.11.1/Dockerfile)
  * DotNet 5.0.302
